...
public class CorsFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        response.setHeader("Access-Control-Allow-Headers", "Origin, X-Key, Content-Type, Authorization"); // 해당 헤더 허용 >> Content-Type, Authorization 중요
        response.setHeader("Access-Control-Allow-Credentials", "true"); // true를 줘야함 >>
